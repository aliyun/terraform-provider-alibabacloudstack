...
func TestAccAlibabacloudStackDmsEnterprisesDataSource(t *testing.T) {
	rand := getAccTestRandInt(1000000, 9999999)
	resourceId := "data.alibabacloudstack_dms_enterprise_instances.default"
	...
	searchkeyConf := dataSourceTestAccConfig{
		...
		fakeConfig: testAccConfig(map[string]interface{}{
			"search_key": "${alibabacloudstack_dms_enterprise_instance.default.host}-fake",
		}),
	}
	instancealiasRegexConfConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"net_type":             "CLASSIC",
			"instance_type":        "${alibabacloudstack_dms_enterprise_instance.default.instance_type}",
			"env_type":             "test",
	...
	var existDmsEnterpriseInstancesMapFunc = func(rand int) map[string]string {
		return map[string]string{
			...
			"instances.0.ecs_region":        os.Getenv("ALIBABACLOUDSTACK_REGION"),
