...
func init() {
	resource.AddTestSweepers("alibabacloudstack_api_gateway_group", &resource.Sweeper{
		Name: "alibabacloudstack_api_gateway_group",
...
func TestAccAlibabacloudStackApigatewayGroup_basic(t *testing.T) {
	var v *cloudapi.DescribeApiGroupResponse

	resourceId := "alibabacloudstack_api_gateway_group.default"
...
func TestAccAlibabacloudStackApigatewayGroup_multi(t *testing.T) {
	var v *cloudapi.DescribeApiGroupResponse
	resourceId := "alibabacloudstack_api_gateway_group.default.9"
	ra := resourceAttrInit(resourceId, apigatewayGroupBasicMap)
	serviceFunc := func() interface{} {
		return &CloudApiService{testAccProvider.Meta().(*connectivity.AlibabacloudStackClient)}
	}
