...
func init() {
	resource.AddTestSweepers(
		...
		&resource.Sweeper{
			Name: "alibabacloudstack_ros_template",
...
func testSweepRosTemplate(region string) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "alibabacloudstack_ros_template", action, AlibabacloudStackSdkGoERROR)
		}
...
func TestAccAlibabacloudStackRosTemplate_basic(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alibabacloudstack_ros_template.default"
	ra := resourceAttrInit(resourceId, AlibabacloudStackRosTemplateMap)
	...
	name := fmt.Sprintf("tf-testAcc%sAlibabacloudStackRosTemplate%d", defaultRegionToTest, rand)
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, AlibabacloudStackRosTemplateBasicDependence)
...
var AlibabacloudStackRosTemplateMap = map[string]string{}

func AlibabacloudStackRosTemplateBasicDependence(name string) string {
	return ""
}
