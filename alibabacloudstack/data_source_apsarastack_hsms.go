...
func dataSourceAlibabacloudStackHsms() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceAlibabacloudStackHsmsRead,
...
func dataSourceAlibabacloudStackHsmsRead(d *schema.ResourceData, meta interface{}) error {
