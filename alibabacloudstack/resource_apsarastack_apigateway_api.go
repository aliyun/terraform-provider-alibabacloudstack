...
func resourceAlibabacloudStackApigatewayApiCreate(d *schema.ResourceData, meta interface{}) error {
	...
	request, err := buildAlibabacloudStackApiArgs(d, meta)
	if err != nil {
	...
	response, ok := raw.(*cloudapi.CreateApiResponse)
	if err != nil {
		errmsg := ""
		if ok {
			errmsg = errmsgs.GetBaseResponseErrorMessage(raw.(*cloudapi.CreateApiResponse).BaseResponse)
		}
		return errmsgs.WrapErrorf(err, errmsgs.RequestV1ErrorMsg, "alibabacloudstack_api-gateway_api", request.GetActionName(), errmsgs.AlibabacloudStackSdkGoERROR, errmsg)
	}
...
func resourceAlibabacloudStackApigatewayApiRead(d *schema.ResourceData, meta interface{}) error {
	...
	client.InitRpcRequest(*request.RpcRequest)
	request.ApiId = d.Get("api_id").(string)
...
func resourceAlibabacloudStackApigatewayApiUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.AlibabacloudStackClient)
	...
	if update {
		...
		response, ok := raw.(*cloudapi.ModifyApiResponse)
		if err != nil {
			errmsg := ""
			if ok {
...
func resourceAlibabacloudStackApigatewayApiDelete(d *schema.ResourceData, meta interface{}) error {
	...
	addDebug(request.GetActionName(), raw, request.RpcRequest, request)
	return errmsgs.WrapError(cloudApiService.WaitForApiGatewayApi(d.Id(), Deleted, DefaultTimeout))
}

func buildAlibabacloudStackApiArgs(d *schema.ResourceData, meta interface{}) (*cloudapi.CreateApiRequest, error) {
...
func requestConfigToJsonStr(l []interface{}) (string, error) {
	...
	return string(configStr), errmsgs.WrapError(err)
}
...
func getHttpServiceConfig(d *schema.ResourceData) ([]byte, error) {
	...
	return configStr, errmsgs.WrapError(err)
}
...
func getHttpVpcServiceConfig(d *schema.ResourceData) ([]byte, error) {
	...
	if !ok {
		return []byte{}, errmsgs.WrapError(errmsgs.Error("Creating apigatway api error: http_vpc_service_config is null"))
	}
	l = v.([]interface{})
...
func getFcServiceConfig(d *schema.ResourceData) ([]byte, error) {
	...
	if !ok {
		return []byte{}, errmsgs.WrapError(errmsgs.Error("Creating apigatway api error: fc_service_config is null"))
	}
	l = v.([]interface{})
...
func getMockServiceConfig(d *schema.ResourceData) ([]byte, error) {
	...
	if !ok {
		return []byte{}, errmsgs.WrapError(errmsgs.Error("Creating apigatway api error: mock_service_config is null"))
	}
	l = v.([]interface{})
...
func setParameters(d *schema.ResourceData) (rps []byte, sps []byte, spm []byte, err error) {
	...
	return rps, sps, spm, errmsgs.WrapError(err)
}
