...
func init() {
	resource.AddTestSweepers("alibabacloudstack_slb_server_certificate", &resource.Sweeper{
		Name: "alibabacloudstack_slb_server_certificate",
...
func TestAccAlibabacloudStackSlbServerCertificate_basic(t *testing.T) {
	var v *slb.ServerCertificate
	resourceId := "alibabacloudstack_slb_server_certificate.default"
