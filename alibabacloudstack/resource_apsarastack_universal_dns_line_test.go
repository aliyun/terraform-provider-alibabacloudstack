...
func TestAccAlibabacloudStackUniversalDnsLine_basic(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alibabacloudstack_universal_dns_line.default"
...
func AlibabacloudTestAccUniversalDnsLinedependence(name string) string {
	return fmt.Sprintf(`
variable "name" {
    default = "%s"
}
