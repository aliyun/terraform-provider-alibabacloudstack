...
func (s *BucketVpcService) BucketVpcList(bucketName string) (vpclist *VpcListResult, err error) {
	...
	if err != nil {
		if ossNotFoundError(err) {
			return vpclist, WrapErrorf(err, NotFoundMsg, AlibabacloudStackOssGoSdk)
		}
		return vpclist, WrapErrorf(err, DefaultErrorMsg, bucketName, "ListBucketVpc", AlibabacloudStackOssGoSdk)
	}
...
func (s *BucketVpcService) BindBucket(vpcId string, vpcName string, vLan string, bucket string) error {
	...
	if err != nil {
		...
		return WrapErrorf(err, DefaultErrorMsg, bucket, "BindBucketPolicy", AlibabacloudStackOssGoSdk)
	}
	...
	if bresponse.GetHttpStatus() != 200 {
		return WrapErrorf(err, DefaultErrorMsg, "alibabacloudstack_oss_bucket_vpc", "BindBucketPolicy", AlibabacloudStackOssGoSdk)
	}
	return nil
}
...
func (s *BucketVpcService) UnBindBucket(vpcId string, bucket string) error {
	...
	if err != nil {
		...
		return WrapErrorf(err, DefaultErrorMsg, bucket, "UnBindBucketPolicy", AlibabacloudStackOssGoSdk)
	}
	...
	if bresponse.GetHttpStatus() != 200 {
		return WrapErrorf(err, DefaultErrorMsg, "alibabacloudstack_oss_bucket_vpc", "UnBindBucketPolicy", AlibabacloudStackOssGoSdk)
	}
	return nil
}
