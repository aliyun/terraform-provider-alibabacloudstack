...
func init() {
	resource.AddTestSweepers("alibabacloudstack_cms_alarm_contact_group", &resource.Sweeper{
		Name: "alibabacloudstack_cms_alarm_contact_group",
...
func TestAccAlibabacloudstackCmsAlarmContactGroup_basic(t *testing.T) {
	testAccPreCheckWithAPIIsNotSupport(t)
	var v cms.ContactGroup
	resourceId := "alibabacloudstack_cms_alarm_contact_group.default"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccConfig(map[string]interface{}{
					"contacts": []string{"${alibabacloudstack_cms_alarm_contact.default.id}"},
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
						"contacts.#": "1",
			...
			},
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"contacts":          []string{"${alibabacloudstack_cms_alarm_contact.default.id}", "${alibabacloudstack_cms_alarm_contact.default0.id}"},
...
resource "alibabacloudstack_cms_alarm_contact" "default0" {
