...
func init() {
	resource.AddTestSweepers("alibabacloudstack_cms_site_monitor", &resource.Sweeper{
		Name: "alibabacloudstack_cms_site_monitor",
...
func TestAccAlibabacloudStackCmsSiteMonitor_basic(t *testing.T) {
	testAccPreCheckWithAPIIsNotSupport(t)
	resourceName := "alibabacloudstack_cms_site_monitor.basic"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("alibabacloudstack_cms_site_monitor.basic", "task_name", "tf-testAccCmsSiteMonitor_basic"),
					resource.TestCheckResourceAttr("alibabacloudstack_cms_site_monitor.basic", "interval", "5"),
					resource.TestCheckResourceAttr("alibabacloudstack_cms_site_monitor.basic", "address", "http://www.alibabacloud.com"),
				),
			},
			{
...
func TestAccAlibabacloudStackCmsSiteMonitor_update(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck: func() {
			testAccPreCheck(t)
		},

		IDRefreshName: "alibabacloudstack_cms_site_monitor.update",
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("alibabacloudstack_cms_site_monitor.update", "task_name", "tf-testAccCmsSiteMonitor_update"),
					resource.TestCheckResourceAttr("alibabacloudstack_cms_site_monitor.update", "interval", "5"),
					resource.TestCheckResourceAttr("alibabacloudstack_cms_site_monitor.update", "address", "http://www.alibabacloud.com"),
					resource.TestCheckResourceAttr("alibabacloudstack_cms_site_monitor.update", "isp_cities.#", "1"),
				),
			},

			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("alibabacloudstack_cms_site_monitor.update", "task_name", "tf-testAccCmsSiteMonitor_updateafter"),
					resource.TestCheckResourceAttr("alibabacloudstack_cms_site_monitor.update", "interval", "1"),
					resource.TestCheckResourceAttr("alibabacloudstack_cms_site_monitor.update", "address", "http://www.alibaba.com"),
					resource.TestCheckResourceAttr("alibabacloudstack_cms_site_monitor.update", "isp_cities.#", "2"),
				),
			},
		},
	})
...
func testAccCheckCmsSiteMonitorDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "alibabacloudstack_cms_site_monitor" {
			continue
		}
...
resource "alibabacloudstack_cms_site_monitor" "update" {
	address = "http://www.alibabacloud.com"
