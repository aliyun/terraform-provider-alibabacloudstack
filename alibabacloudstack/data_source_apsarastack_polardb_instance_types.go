...
func dataSourceAlibabacloudStackPolardbInstanceTypes() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceAlibabacloudStackPolardbInstanceTypesRead,
		...
		Schema: map[string]*schema.Schema{
			...
			"engine": {
				...
				Optional:     true,
				ForceNew:     true,
				ValidateFunc: validation.StringInSlice([]string{"PolarDB_PG", "MySQL", "PolarDB_PPAS"}, false),
			},
			"engine_version": {
				Type:         schema.TypeString,
				Optional:     true,
...
func dataSourceAlibabacloudStackPolardbInstanceTypesRead(d *schema.ResourceData, meta interface{}) error {
	...
	reqQuery := map[string]interface{}{
		...
		"pageSize":     500,
		"label":        "true",
		"resourceType": "polardb-localdisk",
		"status":       "Available",
	}
