...
func init() {
	resource.AddTestSweepers("alibabacloudstack_vpc", &resource.Sweeper{
		Name: "alibabacloudstack_vpc",
		F:    testSweepVpcs,
		Dependencies: []string{
...
func testAccCheckVpcDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "alibabacloudstack_vpc" {
			continue
		}
...
func TestAccAlibabacloudStackVpcBasic(t *testing.T) {
	var v vpc.Vpc
	rand := acctest.RandIntRange(1000000, 9999999)
	resourceId := "alibabacloudstack_vpc.default"
	...
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, AlibabacloudstackVpcBasicDependence)
...
func TestAccAlibabacloudstackVpc_enableIpv6(t *testing.T) {
	var v vpc.Vpc
	resourceId := "alibabacloudstack_vpc.default"
	ra := resourceAttrInit(resourceId, AlibabacloudstackVpcMap1)
	...
	rand := acctest.RandIntRange(1000000, 9999999)
	name := fmt.Sprintf("tf-testAcc%sVpc%d", defaultRegionToTest, rand)
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, AlibabacloudstackVpcBasicDependence1)
	resource.Test(t, resource.TestCase{
		PreCheck: func() {
			testAccPreCheck(t)
			testAccPreCheckWithRegions(t, true, connectivity.VpcIpv6SupportRegions)
...
func TestAccAlibabacloudStackVpcMulti(t *testing.T) {
	var v vpc.Vpc
	rand := acctest.RandInt()
	resourceId := "alibabacloudstack_vpc.default.9"
	ra := resourceAttrInit(resourceId, testAccCheckVpcCheckMap)
	serviceFunc := func() interface{} {
		return &VpcService{testAccProvider.Meta().(*connectivity.AlibabacloudStackClient)}
	}
...
func AlibabacloudstackVpcBasicDependence(name string) string {
	return fmt.Sprintf(`
provider "alibabacloudstack" {
	assume_role {}
}
...
var AlibabacloudstackVpcMap1 = map[string]string{
	"status":          CHECKSET,
	"router_id":       CHECKSET,
	"router_table_id": CHECKSET,
	"route_table_id":  CHECKSET,
...
func AlibabacloudstackVpcBasicDependence1(name string) string {
	return fmt.Sprintf(`
provider "alibabacloudstack" {
	assume_role {}
}
