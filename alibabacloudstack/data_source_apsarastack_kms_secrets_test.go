...
func TestAccAlibabacloudStackKmsSecretsDataSource(t *testing.T) {
	...
	NameRegexConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"name_regex": "^${alibabacloudstack_kms_secret.default.secret_name}",
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"name_regex": "^${alibabacloudstack_kms_secret.default.secret_name}-fake",
		}),
	}
	idsConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"ids": []string{"${alibabacloudstack_kms_secret.default.secret_name}"},
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"ids": []string{"${alibabacloudstack_kms_secret.default.secret_name}-fake"},
		}),
	}
