...
func init() {
	resource.AddTestSweepers("alibabacloudstack_api_gateway_api", &resource.Sweeper{
		Name: "alibabacloudstack_api_gateway_api",
...
func TestAccAlibabacloudStackApigatewayApi_basic(t *testing.T) {
	var api *cloudapi.DescribeApiResponse
	resourceId := "alibabacloudstack_api_gateway_api.default"
...
func TestAccAlibabacloudStackApigatewayApi_vpc(t *testing.T) {
	var api *cloudapi.DescribeApiResponse
	resourceId := "alibabacloudstack_api_gateway_api.default"
	ra := resourceAttrInit(resourceId, apiGatewayApiMap)
	serviceFunc := func() interface{} {
		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"http_vpc_service_config": []map[string]string{{
						"name":      "${alibabacloudstack_api_gateway_vpc_access.default.name}",
						"method":    "GET",
...
func TestAccAlibabacloudStackApigatewayApi_fc(t *testing.T) {
	var api *cloudapi.DescribeApiResponse
	resourceId := "alibabacloudstack_api_gateway_api.default"
	ra := resourceAttrInit(resourceId, apiGatewayApiMap)
	serviceFunc := func() interface{} {
