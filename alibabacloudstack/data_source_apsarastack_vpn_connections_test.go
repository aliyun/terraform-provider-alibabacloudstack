...
func TestAccAlibabacloudStackVpnConnectionsDataSourceBasic(t *testing.T) {
	...
	idsConfig := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"ids": []string{"${alibabacloudstack_vpn_connection.default.id}"},
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"ids": []string{"${alibabacloudstack_vpn_connection.default.id}_fake"},
		}),
	}
	...
	vpnGateWayIdConfig := dataSourceTestAccConfig{
		...
		fakeConfig: testAccConfig(map[string]interface{}{
			"vpn_gateway_id": "${alibabacloudstack_vpn_gateway.default.id}_fake",
		}),
	}

	customerGatewayIdConfig := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"customer_gateway_id": "${alibabacloudstack_vpn_connection.default.customer_gateway_id}",
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"customer_gateway_id": "${alibabacloudstack_vpn_connection.default.customer_gateway_id}_fake",
		}),
	}
