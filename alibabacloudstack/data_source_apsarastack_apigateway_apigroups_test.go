...
func TestAccAlibabacloudStackApigatewayGroupsDataSource(t *testing.T) {
	...
	resourceId := "data.alibabacloudstack_api_gateway_groups.default"
	...
	nameRegexConf := dataSourceTestAccConfig{
		...
		fakeConfig: testAccConfig(map[string]interface{}{
			"name_regex": "${alibabacloudstack_api_gateway_group.default.name}_fake",
		}),
	}

	idsConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"ids": []string{"${alibabacloudstack_api_gateway_group.default.id}"},
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"ids": []string{"${alibabacloudstack_api_gateway_group.default.id}_fake"},
		}),
	}
