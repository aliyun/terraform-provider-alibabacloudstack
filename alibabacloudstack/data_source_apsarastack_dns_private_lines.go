...
func dataSourceAlibabacloudStackDnsPrivateLines() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceAlibabacloudStackDnsPrivateLinesRead,
		...
		Schema: map[string]*schema.Schema{
			"ids": {
				...
				Description: "A list of DNS Private line IDs.",
			},
			"name_regex": {
				Type:         schema.TypeString,
				Optional:     true,
				ValidateFunc: validation.StringIsValidRegExp,
				Description:  "A regex string to filter results by the DNS Private line name.",
			},
			"lines": {
				Type:     schema.TypeList,
				Computed: true,
...
func dataSourceAlibabacloudStackDnsPrivateLinesRead(d *schema.ResourceData, meta interface{}) error {
	...
	response, err := client.DoTeaRequest("POST", "CloudDns", "2021-06-24", "DescribePrivateLines", "", nil, nil, request)
	if err != nil {
		return err
	}
