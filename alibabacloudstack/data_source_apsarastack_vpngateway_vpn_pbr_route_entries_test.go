...
func TestAccAlibabacloudStackVpngatewayVpnPbrRouteEntriesDataSource(t *testing.T) {
	...
	idsConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"vpn_gateway_id": "${alibabacloudstack_vpngateway_vpn_pbr_route_entry.default.vpn_gateway_id}",
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"vpn_gateway_id": "${alibabacloudstack_vpngateway_vpn_pbr_route_entry.default.vpn_gateway_id}-fakeTestAcccc",
		}),
	}
