...
func TestAccAlibabacloudStackCenTransitMulticastDomainSourcePeer(t *testing.T) {
	...
	testAccConfig := resourceTestAccConfigFunc(resourceId, randInt, AlibabacloudTestAccCenTransitMulticastDomainSourcePeerdependence)
	ResourceTest(t, resource.TestCase{
		PreCheck: func() {
...
func AlibabacloudTestAccCenTransitMulticastDomainSourcePeerdependence(randInt string) string {
	return fmt.Sprintf(
		`
variable "name" {
  default = "tf-testaccdomain_source%s"
}
