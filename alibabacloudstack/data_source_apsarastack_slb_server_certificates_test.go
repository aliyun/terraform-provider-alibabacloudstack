...
func TestAccAlibabacloudStackSlbServerCertificatesDataSource_basic(t *testing.T) {
	...
	nameRegexConf := dataSourceTestAccConfig{
		...
		fakeConfig: testAccCheckAlibabacloudStackSlbServerCertificatesDataSourceConfig(rand, map[string]string{
			"name_regex": `"${alibabacloudstack_slb_server_certificate.default.name}_fake"`,
		}),
	}
	idsConf := dataSourceTestAccConfig{
		existConfig: testAccCheckAlibabacloudStackSlbServerCertificatesDataSourceConfig(rand, map[string]string{
			"ids": `["${alibabacloudstack_slb_server_certificate.default.id}"]`,
		}),
		fakeConfig: testAccCheckAlibabacloudStackSlbServerCertificatesDataSourceConfig(rand, map[string]string{
			"ids": `["${alibabacloudstack_slb_server_certificate.default.id}_fake"]`,
		}),
	}
...
func testAccCheckAlibabacloudStackSlbServerCertificatesDataSourceConfig(rand int, attrMap map[string]string) string {
	var pairs []string
