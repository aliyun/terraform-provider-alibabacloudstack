...
func TestAccAlibabacloudStackEcsDedicatedHost_basic(t *testing.T) {
	var v ecs.DedicatedHost
	resourceId := "alibabacloudstack_ecs_dedicated_host.default"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccConfig(map[string]interface{}{
					//"resource_group_id": "${data.alibabacloudstack_resource_manager_resource_groups.default.ids.1}",
