...
func TestAccAlibabacloudStackDTSSynchronizationInstance_basic0(t *testing.T) {

	var v map[string]interface{}
	resourceId := "alibabacloudstack_dts_synchronization_instance.default"

	ra := resourceAttrInit(resourceId, AlibabacloudStackDTSSynchronizationInstanceMap0)
	...
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, AlibabacloudStackDTSSynchronizationInstanceBasicDependence0)
...
var AlibabacloudStackDTSSynchronizationInstanceMap0 = map[string]string{
...
func AlibabacloudStackDTSSynchronizationInstanceBasicDependence0(name string) string {
	return fmt.Sprintf(` 
variable "name" {
  default = "%s"
}
