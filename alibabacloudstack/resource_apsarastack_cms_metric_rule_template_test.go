...
func init() {
	resource.AddTestSweepers(
		...
		&resource.Sweeper{
			Name: "alibabacloudstack_cms_metric_rule_template",
...
func testSweepCmsMetricRuleTemplate(region string) error {
	...
	for {
		...
		for _, v := range result {
			...
			_, err = conn.DoRequest(StringPointer(action), nil, StringPointer("POST"), StringPointer("2019-01-01"), StringPointer("AK"), nil, request, &util.RuntimeOptions{IgnoreSSL: tea.Bool(client.Config.Insecure)})
			if err != nil {
...
var alibabacloudstackCloudMonitorServiceMetricRuleTemplateMap0 = map[string]string{
	"alert_templates.#": CHECKSET,
}

func alibabacloudstackCloudMonitorServiceMetricRuleTemplateBasicDependence0(name string) string {
	return fmt.Sprintf(` 
variable "name" {
  default = "%s"
}
...
// }
// data "alibabacloudstack_slb_zones" "default" {
// 	available_slb_address_type = "vpc"
// }

// data "alibabacloudstack_vswitches" "default" {
// 	vpc_id  = data.alibabacloudstack_vpcs.default.ids.0
// 	zone_id = data.alibabacloudstack_slb_zones.default.zones.0.id
// }

// resource "alibabacloudstack_slb_load_balancer" "default" {
...
// }
// resource "alibabacloudstack_cms_monitor_group_instances" "default" {
//   group_id = alibabacloudstack_cms_monitor_group.default.id
//   instances {
//     instance_id = alibabacloudstack_slb_load_balancer.default.id
//     instance_name = alibabacloudstack_slb_load_balancer.default.name
//     region_id = "%s"
//     category = "slb"
//   }
// }
...
// locals {
//  group_id = alibabacloudstack_cms_monitor_group_instances.default.id
// }

`, name, defaultRegionToTest)
}

// func TestUnitalibabacloudstackCmsMetricRuleTemplate(t *testing.T) {
// 	p := Provider().(*schema.Provider).ResourcesMap
// 	dInit, _ := schema.InternalMap(p["alibabacloudstack_cms_metric_rule_template"].Schema).Data(nil, nil)
// 	dExisted, _ := schema.InternalMap(p["alibabacloudstack_cms_metric_rule_template"].Schema).Data(nil, nil)
...
// 		t.Skipped()
// 	}
// 	rawClient = rawClient.(*connectivity.AlibabacloudStackClient)
...
// 	// Create
// 	patches := gomonkey.ApplyMethod(reflect.TypeOf(&connectivity.AlibabacloudStackClient{}), "NewCmsClient", func(_ *connectivity.AlibabacloudStackClient) (*client.Client, error) {
// 		return nil, &tea.SDKError{
...
// 		}
// 	})
// 	err = resourcealibabacloudstackCmsMetricRuleTemplateCreate(dInit, rawClient)
// 	patches.Reset()
// 	assert.NotNil(t, err)
...
// 		default:
// 			assert.Nil(t, err)
// 			dCompare, _ := schema.InternalMap(p["alibabacloudstack_cms_metric_rule_template"].Schema).Data(dInit.State(), nil)
// 			for key, value := range attributes {
...
// 		}
// 	})
// 	err = resourcealibabacloudstackCmsMetricRuleTemplateUpdate(dExisted, rawClient)
// 	patches.Reset()
// 	assert.NotNil(t, err)
...
// 	}
// 	diff, err := newInstanceDiff("alibabacloudstack_cms_metric_rule_template", attributes, attributesDiff, dInit.State())
// 	if err != nil {
// 		t.Error(err)
// 	}
// 	dExisted, _ = schema.InternalMap(p["alibabacloudstack_cms_metric_rule_template"].Schema).Data(dInit.State(), diff)
// 	ReadMockResponseDiff = map[string]interface{}{
// 		// DescribeMetricRuleTemplateAttribute Response
// 		"Resource": map[string]interface{}{
...
// 		default:
// 			assert.Nil(t, err)
// 			dCompare, _ := schema.InternalMap(p["alibabacloudstack_cms_metric_rule_template"].Schema).Data(dExisted.State(), nil)
// 			for key, value := range attributes {
// 				_ = dCompare.Set(key, value)
// 			}
...
// 		},
// 	}
// 	diff, err = newInstanceDiff("alibabacloudstack_cms_metric_rule_template", attributes, attributesDiff, dExisted.State())
// 	if err != nil {
// 		t.Error(err)
// 	}
// 	dExisted, _ = schema.InternalMap(p["alibabacloudstack_cms_metric_rule_template"].Schema).Data(dExisted.State(), diff)
// 	ReadMockResponseDiff = map[string]interface{}{
// 		// DescribeMetricRuleTemplateAttribute Response
// 		"Resource": map[string]interface{}{
// 			"AlertTemplates": map[string]interface{}{
...
// 			return ReadMockResponse, nil
// 		})
// 		err := resourcealibabacloudstackCmsMetricRuleTemplateRead(dExisted, rawClient)
// 		patches.Reset()
// 		switch errorCode {
// 		case "NonRetryableError":
// 			assert.NotNil(t, err)
...
// 		}
// 	})
// 	err = resourcealibabacloudstackCmsMetricRuleTemplateDelete(dExisted, rawClient)
// 	patches.Reset()
// 	assert.NotNil(t, err)
// 	errorCodes = []string{"NonRetryableError", "Throttling", "nil"}
// 	for index, errorCode := range errorCodes {
