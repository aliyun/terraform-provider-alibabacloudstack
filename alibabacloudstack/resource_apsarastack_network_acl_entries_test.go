...
func SkipTestAccAlibabacloudStackVpcNetworkAclEntries_basic(t *testing.T) {
	resourceId := "alibabacloudstack_network_acl_entries.default"
...
func testAccCheckNetworkAclEntriesDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "alibabacloudstack_network_acl_entries" {
			continue
		}
