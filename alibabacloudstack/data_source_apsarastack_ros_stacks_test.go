...
func TestAccAlibabacloudStackRosStacksDataSource(t *testing.T) {
	resourceId := "data.alibabacloudstack_ros_stacks.default"
	...
	nameRegexConf := dataSourceTestAccConfig{
		...
		fakeConfig: testAccConfig(map[string]interface{}{
			"name_regex":     "${alibabacloudstack_ros_stack.default.stack_name}-fake",
			"enable_details": "true",
		}),
	}
	...
	idsConf := dataSourceTestAccConfig{
		...
		fakeConfig: testAccConfig(map[string]interface{}{
			"ids":            []string{"${alibabacloudstack_ros_stack.default.id}-fake"},
			"enable_details": "true",
		}),
	}
