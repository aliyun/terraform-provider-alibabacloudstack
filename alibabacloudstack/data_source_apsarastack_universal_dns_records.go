...
func dataSourceAlibabacloudStackUniversalDnsRecords() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceAlibabacloudStackUniversalDnsRecordsRead,
...
func dataSourceAlibabacloudStackUniversalDnsRecordsRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		response, err := client.DoTeaRequest("POST", "UniversalDns", "2021-06-24", "DescribeUniversalZoneRecords", "", nil, nil, request)
		if err != nil {
			return errmsgs.WrapErrorf(err, errmsgs.DefaultErrorMsg, "alibabacloudstack_universal_dns_records", "DescribeUniversalZoneRecords", errmsgs.AlibabacloudStackSdkGoERROR)
		}
