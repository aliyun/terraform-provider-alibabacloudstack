...
func TestAccAlibabacloudStackSlbDomainExtensionBasic(t *testing.T) {
	var v *slb.DescribeDomainExtensionAttributeResponse
	resourceId := "alibabacloudstack_slb_domain_extension.default"
		...
		Steps: []resource.TestStep{
			...
			},
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"frontend_port":         "${alibabacloudstack_slb_listener.https.frontend_port}",
					"domain":                "www.test.com",
					"server_certificate_id": "${alibabacloudstack_slb_server_certificate.new.id}",
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
						"load_balancer_id":      CHECKSET,
...
resource "alibabacloudstack_vswitch" "default" {
   ...
   resource "alibabacloudstack_slb" "instance" {
	...
	resource "alibabacloudstack_slb_server_certificate" "new" {
  		name               = "${var.name}"
  		server_certificate = "-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----"
  		private_key        = "-----BEGIN RSA PRIVATE KEY-----\\nliQ9YXhV5Iu2x1pNwrtFnssDdaaGpfA7l3xC00BL7Z+SAJyI4QKA\n-----END RSA PRIVATE KEY-----"
	}
