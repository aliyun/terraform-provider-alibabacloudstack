...
func dataSourceAlibabacloudStackOnsClusters() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceAlibabacloudStackOnsClustersRead,
...
func dataSourceAlibabacloudStackOnsClustersRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.AlibabacloudStackClient)
	request := client.NewCommonRequest("GET", "Ons-inner", "2018-02-05", "ConsoleClusterList", "")
	...
	for _, v := range data.([]interface{}) {
		...
		mapping := map[string]interface{}{
			...
			"cpu_brand": object["cpuBrand"],
			"cpu_arch":  object["clusterName"],
		}
