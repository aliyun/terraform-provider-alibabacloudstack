...
func resourceAlibabacloudStackDnsRecordCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "alibabacloudstack_dns_record", "AddGlobalRrSet", raw)
	}
	addDebug("AddGlobalRrSet", raw, requestInfo, request)

	bresponse, _ := raw.(*responses.CommonResponse)
	if bresponse.GetHttpStatus() != 200 {
		return WrapErrorf(err, DefaultErrorMsg, "alibabacloudstack_dns_record", "AddGlobalRrSet", AlibabacloudStackSdkGoERROR)
	}
...
func resourceAlibabacloudStackDnsRecordUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if d.HasChange("description") {
		...
		if err != nil {
			return WrapErrorf(err, DefaultErrorMsg, "alibabacloudstack_dns_record", "RemarkGlobalRrSet", raw)
		}
	...
	if attributeUpdate {
		...
		if err != nil {
			return WrapErrorf(err, DefaultErrorMsg, "alibabacloudstack_dns_record", "UpdateGlobalRrSet", raw)
		}
		addDebug(request.GetActionName(), raw, request)
