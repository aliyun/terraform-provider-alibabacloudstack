...
func init() {
	resource.AddTestSweepers("alibabacloudstack_alikafka_sasl_acl", &resource.Sweeper{
		Name: "alibabacloudstack_alikafka_sasl_acl",
		...
		Steps: []resource.TestStep{
...

			{
				Config: testAccConfig(map[string]interface{}{
					...
					//"acl_resource_name": "${alibabacloudstack_alikafka_consumer_group.default.consumer_id}",
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
						"acl_resource_type": "Group",
...
//resource "alibabacloudstack_alikafka_consumer_group" "default" {
