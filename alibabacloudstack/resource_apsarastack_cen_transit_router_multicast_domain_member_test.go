...
func TestAccAlibabacloudStackCenTransitMulticastDomainMemberPeer(t *testing.T) {
	...
	testAccConfig := resourceTestAccConfigFunc(resourceId, randInt, AlibabacloudTestAccCenTransitMulticastDomainMemberPeerdependence)
	ResourceTest(t, resource.TestCase{
		PreCheck: func() {
...
func AlibabacloudTestAccCenTransitMulticastDomainMemberPeerdependence(randInt string) string {
	return fmt.Sprintf(
		`
variable "name" {
  default = "tf-testaccdomain_member%s"
}
