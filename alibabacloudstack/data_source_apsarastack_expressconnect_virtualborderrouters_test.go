...
func TestAccAlibabacloudStackExpressConnectVirtualBorderRoutersDataSource(t *testing.T) {
	...
	idsConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"ids": []string{"${alibabacloudstack_express_connect_virtual_border_router.default.id}"},
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"ids": []string{"${alibabacloudstack_express_connect_virtual_border_router.default.id}-fake"},
		}),
	}
			...
			"filter": []map[string]interface{}{
				{
					...
					"values": []string{"${alibabacloudstack_express_connect_virtual_border_router.default.physical_connection_id}"},
				},
				{
					"key":    "VbrId",
					"values": []string{"${alibabacloudstack_express_connect_virtual_border_router.default.id}"},
				},
			},
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"filter": []map[string]interface{}{
				{
					"key":    "PhysicalConnectionId",
					"values": []string{"${alibabacloudstack_express_connect_virtual_border_router.default.physical_connection_id}-fake"},
				},
				{
					"key":    "VbrId",
					"values": []string{"${alibabacloudstack_express_connect_virtual_border_router.default.id}"},
