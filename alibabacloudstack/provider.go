	...
	return &schema.Provider{
		Schema: map[string]*schema.Schema{
			...
			"sls_openapi_endpoint": {
				...
				Deprecated:  "This parameter will no longer be valid and will be removed in 3.21.0.",
			},
			"sts_endpoint": {
				Type:        schema.TypeString,
				Optional:    true,
			...
			"asapi_endpoint": {
				...
				Deprecated:  "Use schema endpoints replace asapi_endpoint. This will be removed in version 3.21.0.",
			},
			"sls_endpoint": {
				Type:        schema.TypeString,
				Optional:    true,
...
func getDataSourcesMap() map[string]*schema.Resource {
	maps := map[string]*schema.Resource{
		...
		"alibabacloudstack_adb_cluster_types":                                dataSourceAlibabacloudStackAdbClusterTypes(),
		...
		"alibabacloudstack_dataworks_file_types":                             dataSourceAlibabacloudStackDataWorksFileTypes(),
		...
		"alibabacloudstack_ecs_dedicated_host_clusters":                      dataSourceAlibabacloudStackEcsDedicatedHostClusters(),
		...
		"alibabacloudstack_ons_clusters":                                     dataSourceAlibabacloudStackOnsClusters(),
		...
		"alibabacloudstack_kvstore_parameter_groups":                         dataSourceAlibabacloudStackKvstoreParameterGroups(),
		"alibabacloudstack_nas_dir_quotas":                                   dataSourceAlibabacloudStackNasDirQuotas(),
		"alibabacloudstack_nas_namespaces":                                   dataSourceAlibabacloudStackNasNamespaces(),
		...
		"alibabacloudstack_edas_k8s_clusters":                                dataSourceAlibabacloudStackEdasK8sClusters(),
		"alibabacloudstack_edas_instance_cluster_attachments":                dataSourceAlibabacloudStackEdasinstanceClusterAttachments(),
		"alibabacloudstack_evpc_evpcs":                                       dataSourceAlibabacloudStackEvpcs(),
		"alibabacloudstack_bcmp_keypairs":                                    dataSourceAlibabacloudStackBcmpKeyPairs(),
		"alibabacloudstack_bmcp_keypairs":                                    dataSourceAlibabacloudStackBcmpKeyPairs(),
		"alibabacloudstack_bcmp_security_groups":                             dataSourceAlibabacloudStackBmcpSecurityGroups(),
		"alibabacloudstack_bmcp_security_groups":                             dataSourceAlibabacloudStackBmcpSecurityGroups(),
		"alibabacloudstack_bcmp_security_group_rules":                        dataSourceAlibabacloudStackBmcpSecurityGroupRules(),
		"alibabacloudstack_bmcp_security_group_rules":                        dataSourceAlibabacloudStackBmcpSecurityGroupRules(),
...
func getResourcesMap() map[string]*schema.Resource {
	maps := map[string]*schema.Resource{
		...
		"alibabacloudstack_edas_application_scale":             resourceAlibabacloudStackEdasInstanceApplicationScale(),
		...
		"alibabacloudstack_data_works_file":                                 resourceAlibabacloudStackDataWorksFile(),
		...
		"alibabacloudstack_kvstore_parameter_group":                         resourceAlibabacloudStackKvstoreParameterGroup(),
		"alibabacloudstack_nas_dir_quota":                                   resourceAlibabacloudStackNasDirQuota(),
		"alibabacloudstack_nas_namespace":                                   resourceAlibabacloudStackNasNamespace(),
		...
		"alibabacloudstack_evpc_evpc":                                       resourceAlibabacloudStackEvpc(),
		"alibabacloudstack_bcmp_keypair":                                    resourceAlibabacloudStackBcmpKeyPair(),
		"alibabacloudstack_bmcp_keypair":                                    resourceAlibabacloudStackBcmpKeyPair(),
		"alibabacloudstack_bcmp_security_group":                             resourceAlibabacloudStackBmcpSecurityGroup(),
		"alibabacloudstack_bmcp_security_group":                             resourceAlibabacloudStackBmcpSecurityGroup(),
		"alibabacloudstack_bcmp_security_group_rule":                        resourceAlibabacloudStackBmcpSecurityGroupRule(),
		"alibabacloudstack_bmcp_security_group_rule":                        resourceAlibabacloudStackBmcpSecurityGroupRule(),
