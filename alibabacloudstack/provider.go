...
func getDataSourcesMap() map[string]*schema.Resource {
	maps := map[string]*schema.Resource{
		...
		"alibabacloudstack_mongodb_sharding_network_public_addresses": dataSourceAlibabacloudStackMongodbShardingNetworkPublicAddresses(),
...
func getResourcesMap() map[string]*schema.Resource {
	maps := map[string]*schema.Resource{
		...
		"alibabacloudstack_mongodb_sharding_network_public_address": resourceAlibabacloudStackMongodbShardingnetworkpublicaddress(),
