...
func TestAccAlibabacloudStackDnsLine_basic(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alibabacloudstack_dns_line.default"
...
func AlibabacloudTestAccDnsLinedependence(name string) string {
	return fmt.Sprintf(`
variable "name" {
    default = "%s"
}
