...
func init() {
	resource.AddTestSweepers("alibabacloudstack_snapshot_policy", &resource.Sweeper{
		Name: "alibabacloudstack_snapshot_policy",
...
func TestAccAlibabacloudStackSnapshotPolicyBasic(t *testing.T) {

	resourceId := "alibabacloudstack_snapshot_policy.default"
...
func TestAccApsarStackSnapshotPolicyMulti(t *testing.T) {
	...
	resourceId := "alibabacloudstack_snapshot_policy.default.4"
	randInt := acctest.RandIntRange(10000, 99999)
	var v *ecs.AutoSnapshotPolicy
