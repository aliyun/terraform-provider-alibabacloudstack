...
func init() {
	resource.AddTestSweepers("alibabacloudstack_arms_alert_contact", &resource.Sweeper{
		Name: "alibabacloudstack_arms_alert_contact",
...
func testSweepArmsAlertContact(region string) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "alibabacloudstack_arms_alert_contacts", action, AlibabacloudStackSdkGoERROR)
		}
...
func TestAccAlibabacloudStackArmsAlertContact_basic(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alibabacloudstack_arms_alert_contact.default"
