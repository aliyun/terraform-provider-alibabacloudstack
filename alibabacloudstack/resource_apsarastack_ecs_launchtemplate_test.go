...
func init() {
	resource.AddTestSweepers("alibabacloudstack_launch_template", &resource.Sweeper{
		Name: "alibabacloudstack_launch_template",
		F:    testAlibabacloudStackLaunchTemplate,
	})
}

func testAlibabacloudStackLaunchTemplate(region string) error {
	...
	if err != nil {
		return errmsgs.WrapErrorf(err, errmsgs.DefaultErrorMsg, region, request.GetActionName(), errmsgs.AlibabacloudStackSdkGoERROR)
	}
...
func TestAccAlibabacloudStackLaunchTemplateBasic(t *testing.T) {
	var v ecs.LaunchTemplateSet

	resourceId := "alibabacloudstack_launch_template.default"
	...
	ResourceTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccConfig(map[string]interface{}{
					"security_group_id": "${alibabacloudstack_security_group.default.id}_change",
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
			...
			{
				Config: testAccConfig(map[string]interface{}{
					"instance_type": "${data.alibabacloudstack_instance_types.default.instance_types.0.id}_change",
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
			...
			{
				Config: testAccConfig(map[string]interface{}{
					"image_id": "${data.alibabacloudstack_images.default.images.0.id}_change",
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
						"image_id": CHECKSET,
...
func TestAccAlibabacloudStackLaunchTemplateMulti(t *testing.T) {
	var v ecs.LaunchTemplateSet

	resourceId := "alibabacloudstack_launch_template.default.4"
	ra := resourceAttrInit(resourceId, testAccLaunchTemplateCheckMap)
	serviceFunc := func() interface{} {
		return &EcsService{testAccProvider.Meta().(*connectivity.AlibabacloudStackClient)}
	}
