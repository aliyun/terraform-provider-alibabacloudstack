...
func init() {
	resource.AddTestSweepers("alibabacloudstack_slb_acl", &resource.Sweeper{
		Name: "alibabacloudstack_slb_acl",
		F:    testSweepSlbAcl,
	})
}
...
func TestAccAlibabacloudStackSlbAcl_basic(t *testing.T) {
	var acl *slb.DescribeAccessControlListAttributeResponse

	resourceId := "alibabacloudstack_slb_acl.default"
...
func TestAccAlibabacloudStackSlbAcl_muilt(t *testing.T) {
	var acl *slb.DescribeAccessControlListAttributeResponse

	resourceId := "alibabacloudstack_slb_acl.default.9"
	ra := resourceAttrInit(resourceId, nil)
	rc := resourceCheckInit(resourceId, &acl, func() interface{} {
		return &SlbService{testAccProvider.Meta().(*connectivity.AlibabacloudStackClient)}
	})
