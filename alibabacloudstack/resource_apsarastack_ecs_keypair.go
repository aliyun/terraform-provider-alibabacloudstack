	...
	resource := &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"key_name_prefix": {
				...
				Deprecated:    "Field 'key_name_prefix' is deprecated and will and is scheduled for removal in version 3.21.0. Please use new field 'key_pair_name' instead.",
				ConflictsWith: []string{"key_name", "key_pair_name"},
			},
			"public_key": {
				Type:     schema.TypeString,
				Optional: true,
