...
func TestAccAlibabacloudStackSlbRulesDataSource_basic(t *testing.T) {
	ResourceTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckAlibabacloudStackSlbRulesDataSourceConfig,
				Check: resource.ComposeTestCheckFunc(

					testAccCheckAlibabacloudStackDataSourceID("data.alibabacloudstack_slb_rules.default"),
					resource.TestCheckResourceAttr("data.alibabacloudstack_slb_rules.default", "load_balancer_id.#", "0"),
				),
...
const testAccCheckAlibabacloudStackSlbRulesDataSourceConfig = DataAlibabacloudstackVswitchZones + DataAlibabacloudstackInstanceTypes + DataAlibabacloudstackImages + `
variable "name" {
