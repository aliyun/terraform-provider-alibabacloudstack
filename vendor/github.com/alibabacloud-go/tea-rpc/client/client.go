...
func (client *Client) DoRequestWithOrg(action *string, protocol *string, method *string, version *string, authType *string, query map[string]interface{}, body map[string]interface{}, runtime *util.RuntimeOptions) (_result map[string]interface{}, _err error) {
	_err = tea.Validate(runtime)
	if _err != nil {
		return _result, _err
	}
...
func (client *Client) DoRequesttowpoint1(action *string, protocol *string, method *string, version *string, authType *string, query map[string]interface{}, body map[string]interface{}, runtime *util.RuntimeOptions) (_result map[string]interface{}, _err error) {
	_err = tea.Validate(runtime)
	if _err != nil {
		return _result, _err
	}
	...
	for _retryTimes := 0; tea.BoolValue(tea.AllowRetry(_runtime["retry"], tea.Int(_retryTimes))); _retryTimes++ {
		...
		_resp, _err = func() (map[string]interface{}, error) {
			...
			if !tea.BoolValue(util.EqualString(authType, tea.String("Anonymous"))) {
				...
				request_.Query["SignatureMethod"] = tea.String("HMAC-SHA1")
				request_.Query["SignatureVersion"] = tea.String("2.1")
				request_.Query["AccessKeyId"] = accessKeyId
				signedParam := tea.Merge(request_.Query,
					rpcutil.Query(body))
				request_.Query["Signature"] = rpcutil.GetSignatureV1(signedParam, request_.Method, accessKeySecret)
