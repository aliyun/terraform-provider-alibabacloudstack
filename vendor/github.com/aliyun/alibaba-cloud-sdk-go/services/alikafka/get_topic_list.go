...
type TopicList struct {
	InstanceDo InstanceDo `json:"instanceDo" xml:"instanceDo"`
...
type GetTopicListResponse struct {
	*responses.BaseResponse
	...
	//ConsumerList   ConsumerListInGetTopicList `json:"ConsumerList" xml:"ConsumerList"`
	TopicList []TopicList 			`json:"ConsumerList" xml:"ConsumerList"`
}
