...
func (client *Client) DescribeCommSelect(request *DescribeCommSelectRequest) (response *DescribeCommSelectResponse, err error) {
	response = CreateSelectCommResponse()
	err = client.DoAction(request, response)
	return
}
...
type DescribeCommSelectRequest struct {
	*requests.RpcRequest
	ResourceType string           `position:"Query" name:"ResourceType"`
	Status       string           `position:"Query" name:"status"`
	isFormat     requests.Boolean `position:"Query" name:"isFormat"`
}

type DescribeCommSelectResponse struct {
	*responses.BaseResponse
	...
	Data []struct {
		ComboTypeLabel        string `json:"comboTypeLabel"`
...
func CreateDescribeZonesRequest() (request *DescribeZonesRequest) {
	...
	request.Headers["x-ascm-product-name"] = "R-kvstore"
	return
}

func CreateSelectCommRequest() (request *DescribeCommSelectRequest) {
	request = &DescribeCommSelectRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("ascm", "2019-05-10", "SelectCommonSpec", "redisa", "openAPI")
	request.Method = requests.POST
	request.Headers["x-ascm-product-name"] = "ascm"
	return
}

func CreateSelectCommResponse() (response *DescribeCommSelectResponse) {
	response = &DescribeCommSelectResponse{
