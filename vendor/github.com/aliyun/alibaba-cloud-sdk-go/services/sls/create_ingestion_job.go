...
func (client *Client) CreateLogMachineGroup(request *CreateLogMachineRequest) (response *CreateIngestionJobResponse, err error) {
...
func (client *Client) CreateIngestionJobWithChan(request *CreateLogMachineRequest) (<-chan *CreateIngestionJobResponse, <-chan error) {
	responseChan := make(chan *CreateIngestionJobResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.CreateLogMachineGroup(request)
		if err != nil {
			errChan <- err
		} else {
...
func (client *Client) CreateIngestionJobWithCallback(request *CreateLogMachineRequest, callback func(response *CreateIngestionJobResponse, err error)) <-chan int {
...
type CreateLogMachineRequest struct {
	*requests.RpcRequest
...
func CreateCreateIngestionJobRequest() (request *CreateLogMachineRequest) {
	request = &CreateLogMachineRequest{
