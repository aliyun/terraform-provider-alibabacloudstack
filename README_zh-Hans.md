...
> + 非LTS版本将不提供编译好的Provider。如有需要请自行编译。

| 阿里云专有云飞天企业版版本 | 版本类型 | AlibabacloudStack版本 | Provider状态 |
| --- | --- | --- |
| v3.16.2 | LTS | < 3.18.0 | BUG支持中 |
| v3.18.x | LTS | < 3.19.0 | 维护中 |
| v3.19.0 | 非LTS | < 3.20.0 | BUG支持中 |
