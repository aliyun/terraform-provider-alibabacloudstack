...
>
> + 如果阿里云专有云飞天企业版版本为3.16.2, AlibabacloudStack版本为 3.16.x，获取最新版本可使用`< 3.18.0`声明版本号。
>
> + 如果阿里云专有云飞天企业版版本为3.18.x(3.18.0,3.18.1,3.18.2,3.18.6), AlibabacloudStack版本为 3.18.x，获取最新版本可使用`< 3.19.0`声明版本号。**注意**，因版本差异，请使用对应版本文档。
>
...
> **注意**：你可以根据你的需求指定Provider的版本，如果不声明，则默认使用最新版本。
...
provider "alibabacloudstack" {
  ...
  # domain = "xxx.xxx.com"       # 阿里云专有云飞天企业版ASAPI网关服务地址，已经废弃
