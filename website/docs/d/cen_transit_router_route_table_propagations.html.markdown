...
The following arguments are supported:
  * `ids` - (Optional) - the ids of the cen transit router route table propagation.
  * `transit_router_route_table_id` - (Required) - the id of the cen  transit router route table.

## Attributes Reference

The following attributes are exported in addition to the arguments listed above:
  * `transit_router_route_propagations` - the list of the cen transit router route table propagation.
