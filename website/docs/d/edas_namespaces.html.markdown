...
* `namespaces` - A list of Edas Namespaces. Each element contains the following attributes:
  ...
  * `debug_enable` - Indicates whether remote debugging is allowed in this namespace.
  ...
  * `mse_instance_id` - The ID of the MSE (Microservices Engine) registry instance associated with this namespace.
  ...
  * `registry_type` - The type of the registry. Valid values: `default` (the shared registry of EDAS), `exclusive_mse` (an MSE Nacos registry).
