...
* `group_name` - (Required, Forces new resource when changed) The name of the Kafka group. Must comply with DataHub naming conventions, with a length limit of 1-128 characters.
* `project_name` - (Required, Forces new resource when changed) The name of the DataHub project. Must already exist and comply with DataHub project naming conventions.
