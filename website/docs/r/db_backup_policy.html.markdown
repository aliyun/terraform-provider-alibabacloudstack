...
page_title: "Alibabacloudstack: alibabacloudstack_db_backup_policy"
sidebar_current: "docs-alibabacloudstack-resource-db-backup-policy"
description: |-
  Provides an RDS backup policy resource.
---

# alibabacloudstack\_db\_backup\_policy
...
resource "alibabacloudstack_db_backup_policy" "policy" {
