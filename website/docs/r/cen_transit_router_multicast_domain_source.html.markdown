...
page_title: "Alibabacloudstack: alibabacloudstack_cen_transit_router_multicast_domain_source"
sidebar_current: "docs-Alibabacloudstack-resource-cen-transit-router-multicast-domain-source"
description: |-
  Provides a AlibabacloudStack CEN transit router multicast domain source resource.
---
...
For information about CEN transit router multicast domain source and how to use it, see [What is Transit Router Multicast Domain Source](https://www.alibabacloud.com/help/doc-detail/).
...
* `group_ip_address` - (Required) The multicast IP address.
* `transit_router_multicast_domain_id` - (Required, ForceNew) The ID of the transit router multicast domain.
...
* `status` - The status of the multicast source.
