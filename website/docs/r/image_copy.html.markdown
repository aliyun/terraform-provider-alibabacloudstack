...
* `source_region_id` - (Required, ForceNew) The ID of the region to which the source custom image belongs. You can call [DescribeRegions](https://www.Alibabacloudstackcloud.com/help/doc-detail/25609.htm) to view the latest regions of Alibabacloudstack Cloud.
