...
sidebar_current: "docs-Alibabacloudstack-resource-polardbx-instance"
description: |-
  Provides a PolarDB-X instance resource.
---
...
* `storage` - (Required, ForceNew) The storage size of the PolarDB-X instance, in GB.
...
* `cpu_type` - (Optional) The CPU architecture type of the PolarDB-X instance.
* `description` - (Optional) The description of the PolarDB-X instance.
* `engine_version` - (Optional, ForceNew) The engine version of the PolarDB-X instance. Valid values: `5.7`, `8.0`.
* `gms_node_class` - (Optional) The specification of the GMS (Global Meta Service) node.
* `polardbx_instance_id` - (Optional) The ID of the PolarDB-X instance.
...
PolarDB-X instance can be imported using the instance ID, e.g.

```
$ terraform import alibabacloudstack_polardbx_instance.example px-12345678
```
