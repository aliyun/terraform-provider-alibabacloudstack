...
description: |-
  Provides a PolarDB cluster backup policy resource.
---
...
resource "alibabacloudstack_polardb_cluster_backup_policy" "example" {
  ...
  # Optional parameters for backup policy
...
* `data_level1_backup_period` - (Optional) The period of Level-1 data backups.
* `data_level1_backup_time` - (Optional) The time of Level-1 data backups.
* `data_level1_backup_retention_period` - (Optional) The retention period of Level-1 data backups.
* `log_backup_retention_period` - (Optional) The retention period of log backups.
