...
page_title: "Alibabacloudstack: alibabacloudstack_express_connect_virtual_border_router"
sidebar_current: "docs-alibabacloudstack-resource-express-connect-virtual-border-router"
description: |-
  Provides a Alibabacloudstack Express Connect Virtual Border Router resource.
---

# alibabacloudstack\_express\_connect\_virtual\_border\_router

Provides a Express Connect Virtual Border Router resource.

For information about Express Connect Virtual Border Router and how to use it, see [What is Virtual Border Router](https://help.aliyun.com/apsara/enterprise/v_3_16_2_20220708/expressconnect/enterprise-developer-guide/CreateVirtualBorderRouter.html?spm=a2c4g.14484438.10001.80).
...
* `route_table_id` - The Route Table ID Of the Virtual Border Router.
...
```
$ terraform import alibabacloudstack_express_connect_virtual_border_router.example <id>
```
