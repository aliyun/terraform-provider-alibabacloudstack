...
page_title: "Alibabacloudstack: alibabacloudstack_mongodb_shardinginstance_mongosnode_address" 
sidebar_current: "docs-Alibabacloudstack-resource-mongodb-shardinginstance-mongosnode-address"
description: |- 
...
resource "alibabacloudstack_mongodb_shardinginstance_csnode_address" "default" {
...
* `public_connect_string_prefix` - Prefix of the public connection string.
* `private_connect_string_prefix` - Prefix of the private connection string.
