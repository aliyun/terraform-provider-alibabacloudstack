...
page_title: "Alibabacloudstack: alibabacloudstack_slb_domain_extension"
sidebar_current: "docs-alibabacloudstack-resource-slb-domain-extension"
description: |-
  Provides a Load Banlancer domain extension Resource and add it to one Listener.
---

# alibabacloudstack\_slb\_domain_extension
...
resource "alibabacloudstack_slb_domain_extension" "example1" {
  load_balancer_id      = "${alibabacloudstack_slb.instance.id}"
