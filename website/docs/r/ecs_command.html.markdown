...
* `name` - (Required, ForceNew) The name of the command. It must be unique and can contain up to 128 characters.
...
* `working_dir` - (Optional, ForceNew) The working directory where the command will be executed on the ECS instance.
