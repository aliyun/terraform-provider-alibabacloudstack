...
func dataSourceApsaraStackEcsDeploymentSets() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackEcsDeploymentSetsRead,
...
func dataSourceApsaraStackEcsDeploymentSetsRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_ecs_deployment_sets", action, ApsaraStackSdkGoERROR)
		}
