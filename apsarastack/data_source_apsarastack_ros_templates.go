...
func dataSourceApsaraStackRosTemplates() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackRosTemplatesRead,
...
func dataSourceApsaraStackRosTemplatesRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_ros_templates", action, ApsaraStackSdkGoERROR)
		}
