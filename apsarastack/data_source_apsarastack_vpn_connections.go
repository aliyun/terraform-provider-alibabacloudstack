...
func dataSourceApsaraStackVpnConnections() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackVpnConnectionsRead,
...
func dataSourceApsaraStackVpnConnectionsRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_vpn_connections", request.GetActionName(), ApsaraStackSdkGoERROR)
		}
