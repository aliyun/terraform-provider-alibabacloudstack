...
func dataSourceApsaraStackDatahubService() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackDatahubServiceRead,
...
func dataSourceApsaraStackDatahubServiceRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		...
		return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_datahub_service", action, ApsaraStackSdkGoERROR)
	}
	d.SetId("DatahubServiceHasBeenOpened")
	d.Set("status", "Opened")
