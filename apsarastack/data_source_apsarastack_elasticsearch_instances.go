...
func dataSourceApsaraStackElasticsearch() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackElasticsearchRead,
...
func dataSourceApsaraStackElasticsearchRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_elasticsearch_instances", request.GetActionName(), ApsaraStackSdkGoERROR)
		}
