...
func dataSourceApsaraStackNasMountTargets() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackNasMountTargetsRead,
...
func dataSourceApsaraStackNasMountTargetsRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_nas_mount_targets", action, ApsaraStackSdkGoERROR)
		}
