...
func dataSourceApsaraStackEcsDedicatedHosts() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackEcsDedicatedHostsRead,
...
func dataSourceApsaraStackEcsDedicatedHostsRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_ecs_dedicated_hosts", action, ApsaraStackSdkGoERROR)
		}
