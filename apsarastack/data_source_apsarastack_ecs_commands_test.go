...
func TestAccApsaraStackEcsCommandsDataSource(t *testing.T) {
	resourceId := "data.apsarastack_ecs_commands.default"
	...
	idsConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"ids": []string{"${apsarastack_ecs_command.default.id}"},
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"ids": []string{"${apsarastack_ecs_command.default.id}-fake"},
		}),
	}
