...
func init() {
	resource.AddTestSweepers("apsarastack_alikafka_sasl_acl", &resource.Sweeper{
		Name: "apsarastack_alikafka_sasl_acl",
...
func TestAccApsaraStackAlikafkaSaslAcl_basic(t *testing.T) {

	var v *alikafka.KafkaAclList
	resourceId := "apsarastack_alikafka_sasl_acl.default"
		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"username":                  "${apsarastack_alikafka_sasl_user.default.username}",
					"acl_resource_type":         "Topic",
					"acl_resource_name":         "${apsarastack_alikafka_topic.default.topic}",
...

			{
				Config: testAccConfig(map[string]interface{}{
					...
					//"acl_resource_name": "${apsarastack_alikafka_consumer_group.default.consumer_id}",
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
						"acl_resource_type": "Group",
...
//}
//
//resource "apsarastack_alikafka_instance" "default" {
//  name = "${var.name}"
//  topic_quota = "50"
//  disk_type = "1"
//  disk_size = "500"
...
//  security_group = apsarastack_security_group.default.id
//}

resource "apsarastack_alikafka_topic" "default" {
  instance_id = "cluster-private-paas-default"
  topic = "${var.name}"
  remark = "topic-remark"
}

//resource "apsarastack_alikafka_consumer_group" "default" {
//  instance_id = "${apsarastack_alikafka_instance.default.id}"
//  consumer_id = "${var.name}"
//}

resource "apsarastack_alikafka_sasl_user" "default" {
  instance_id = "cluster-private-paas-default"
  username = "${var.name}"
  password = "password"
  type     = "scram"
