...
func resourceApsaraStackVpcIpv6Gateway() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackVpcIpv6GatewayCreate,
		Read:   resourceApsaraStackVpcIpv6GatewayRead,
		Update: resourceApsaraStackVpcIpv6GatewayUpdate,
		Delete: resourceApsaraStackVpcIpv6GatewayDelete,
...
func resourceApsaraStackVpcIpv6GatewayCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_vpc_ipv6_gateway", action, ApsaraStackSdkGoERROR)
	}
	...
	return resourceApsaraStackVpcIpv6GatewayRead(d, meta)
}
func resourceApsaraStackVpcIpv6GatewayRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	vpcService := VpcService{client}
	object, err := vpcService.DescribeVpcIpv6Gateway(d.Id())
	if err != nil {
		if NotFoundError(err) {
			log.Printf("[DEBUG] Resource apsarastack_vpc_ipv6_gateway vpcService.DescribeVpcIpv6Gateway Failed!!! %s", err)
			d.SetId("")
			return nil
		}
		return WrapError(err)
...
func resourceApsaraStackVpcIpv6GatewayUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	vpcService := VpcService{client}
	var response map[string]interface{}
	d.Partial(true)
...
func resourceApsaraStackVpcIpv6GatewayDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	vpcService := VpcService{client}
