...
func init() {
	resource.AddTestSweepers("apsarastack_api_gateway_api", &resource.Sweeper{
		Name: "apsarastack_api_gateway_api",
...
func TestAccApsaraStackApigatewayApi_basic(t *testing.T) {
	var api *cloudapi.DescribeApiResponse
	resourceId := "apsarastack_api_gateway_api.default"
...
func TestAccApsaraStackApigatewayApi_vpc(t *testing.T) {
	var api *cloudapi.DescribeApiResponse
	resourceId := "apsarastack_api_gateway_api.default"
	ra := resourceAttrInit(resourceId, apiGatewayApiMap)
	serviceFunc := func() interface{} {
		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"http_vpc_service_config": []map[string]string{{
						"name":      "${apsarastack_api_gateway_vpc_access.default.name}",
						"method":    "GET",
...
func TestAccApsaraStackApigatewayApi_fc(t *testing.T) {
	var api *cloudapi.DescribeApiResponse
	resourceId := "apsarastack_api_gateway_api.default"
	ra := resourceAttrInit(resourceId, apiGatewayApiMap)
	serviceFunc := func() interface{} {
...
func TestAccApsaraStackApigatewayApi_multi(t *testing.T) {
	var api *cloudapi.DescribeApiResponse
	resourceId := "apsarastack_api_gateway_api.default.9"
	ra := resourceAttrInit(resourceId, apiGatewayApiMap)
	serviceFunc := func() interface{} {
		return &CloudApiService{testAccProvider.Meta().(*connectivity.ApsaraStackClient)}
	}
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					"name":        "${apsarastack_api_gateway_group.default.name}" + "${count.index}",
					"group_id":    "${apsarastack_api_gateway_group.default.id}",
					"description": "tf_testAcc_api description",
					"auth_type":   "APP",
					"request_config": []map[string]string{{
