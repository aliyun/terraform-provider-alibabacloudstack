...
func TestAccApsaraStackOtsTablesDataSource_basic(t *testing.T) {
	rand := acctest.RandIntRange(10000, 99999)
	resourceId := "data.apsarastack_ots_tables.default"
	...
	instanceNameConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"instance_name": "${apsarastack_ots_table.default.instance_name}",
		}),
	}
	idsConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"instance_name": "${apsarastack_ots_table.default.instance_name}",
			"ids":           []string{"${apsarastack_ots_table.default.id}"},
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"instance_name": "${apsarastack_ots_table.default.instance_name}",
			"ids":           []string{"${apsarastack_ots_table.default.id}-fake"},
		}),
	}
	...
	nameRegexConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"instance_name": "${apsarastack_ots_table.default.instance_name}",
			"name_regex":    "${apsarastack_ots_table.default.table_name}",
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"instance_name": "${apsarastack_ots_table.default.instance_name}",
			"name_regex":    "${apsarastack_ots_table.default.table_name}-fake",
		}),
	}
...
func dataSourceOtsTablesConfigDependence(name string) string {
	...
	resource "apsarastack_ots_table" "default" {
