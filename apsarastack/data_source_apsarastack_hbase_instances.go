...
func dataSourceApsaraStackHBaseInstances() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackHBaseInstancesRead,
...
func dataSourceApsaraStackHBaseInstancesRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_hbase_instances", request.GetActionName(), ApsaraStackSdkGoERROR)
		}
