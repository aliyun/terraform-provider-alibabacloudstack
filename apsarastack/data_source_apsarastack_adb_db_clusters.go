...
func dataSourceApsaraStackAdbDbClusters() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackAdbDbClustersRead,
...
func dataSourceApsaraStackAdbDbClustersRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_adb_db_clusters", action, ApsaraStackSdkGoERROR)
		}
