...
func resourceApsaraStackNasFileSystem() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackNasFileSystemCreate,
		Read:   resourceApsaraStackNasFileSystemRead,
		Update: resourceApsaraStackNasFileSystemUpdate,
		Delete: resourceApsaraStackNasFileSystemDelete,
...
func resourceApsaraStackNasFileSystemCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_nas_file_system", action, ApsaraStackSdkGoERROR)
	}
	...
	return resourceApsaraStackNasFileSystemUpdate(d, meta)
}

func resourceApsaraStackNasFileSystemUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	var response map[string]interface{}
	...
	return resourceApsaraStackNasFileSystemRead(d, meta)
}

func resourceApsaraStackNasFileSystemRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	nasService := NasService{client}
...
func resourceApsaraStackNasFileSystemDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
