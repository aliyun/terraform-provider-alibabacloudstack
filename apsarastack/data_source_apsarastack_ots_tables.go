...
func dataSourceApsaraStackOtsTables() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackOtsTablesRead,
...
func dataSourceApsaraStackOtsTablesRead(d *schema.ResourceData, meta interface{}) error {
