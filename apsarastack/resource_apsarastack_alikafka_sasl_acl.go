...
func resourceApsaraStackAlikafkaSaslAcl() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackAlikafkaSaslAclCreate,
		Read:   resourceApsaraStackAlikafkaSaslAclRead,
		Delete: resourceApsaraStackAlikafkaSaslAclDelete,
...
func resourceApsaraStackAlikafkaSaslAclCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_alikafka_sasl_acl", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
	...
	return resourceApsaraStackAlikafkaSaslAclRead(d, meta)
}

func resourceApsaraStackAlikafkaSaslAclRead(d *schema.ResourceData, meta interface{}) error {
...
func resourceApsaraStackAlikafkaSaslAclDelete(d *schema.ResourceData, meta interface{}) error {
