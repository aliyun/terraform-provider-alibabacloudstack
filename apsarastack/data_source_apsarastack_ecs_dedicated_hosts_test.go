...
func TestAccApsaraStackEcsDedicatedHostsDataSource(t *testing.T) {
	rand := acctest.RandIntRange(1000000, 9999999)
	resourceId := "data.apsarastack_ecs_dedicated_hosts.default"
	...
	idsConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"ids": []string{"${apsarastack_ecs_dedicated_host.default.id}"},
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"ids": []string{"${apsarastack_ecs_dedicated_host.default.id}-fake"},
		}),
	}
