...
func init() {
	resource.AddTestSweepers("apsarastack_api_gateway_group", &resource.Sweeper{
		Name: "apsarastack_api_gateway_group",
...
func TestAccApsaraStackApigatewayGroup_basic(t *testing.T) {
	var v *cloudapi.DescribeApiGroupResponse

	resourceId := "apsarastack_api_gateway_group.default"
...
func TestAccApsaraStackApigatewayGroup_multi(t *testing.T) {
	var v *cloudapi.DescribeApiGroupResponse
	resourceId := "apsarastack_api_gateway_group.default.9"
	ra := resourceAttrInit(resourceId, apigatewayGroupBasicMap)
	serviceFunc := func() interface{} {
		return &CloudApiService{testAccProvider.Meta().(*connectivity.ApsaraStackClient)}
	}
