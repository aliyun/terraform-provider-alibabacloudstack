...
func TestAccApsaraStackOtsTable_basic(t *testing.T) {
	var v *tablestore.DescribeTableResponse

	resourceId := "apsarastack_ots_table.default"
...
//func TestAccApsaraStackOtsTable_highPerformance(t *testing.T) {
//	var v *tablestore.DescribeTableResponse
//
//	resourceId := "apsarastack_ots_table.default"
//	ra := resourceAttrInit(resourceId, otsTableBasicMap)
...
//func TestAccApsaraStackOtsTable_multi(t *testing.T) {
//	var v *tablestore.DescribeTableResponse
//
//	resourceId := "apsarastack_ots_table.default.4"
//	ra := resourceAttrInit(resourceId, otsTableBasicMap)
//	serviceFunc := func() interface{} {
//		return &OtsService{testAccProvider.Meta().(*connectivity.ApsaraStackClient)}
//	}
...
func testAccCheckOtsTableDestroy(s *terraform.State) error {
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "apsarastack_ots_table" {
			continue
		}
