...
func TestAccApsaraStackCSKubernetesNodePool_basic(t *testing.T) {
	var v *cs.NodePoolDetail

	resourceId := "apsarastack_cs_kubernetes_node_pool.default"
		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"vswitch_ids":           []string{"${apsarastack_vswitch.default.id}"},
					"instance_types":        []string{"${data.apsarastack_instance_types.default.instance_types.0.id}"},
					"node_count":            "1",
					"key_name":              "cck8s123",
...
func TestAccApsaraStackCSKubernetesNodePool_autoScaling(t *testing.T) {
	var v *cs.NodePoolDetail

	resourceId := "apsarastack_cs_kubernetes_node_pool.autocaling"
	ra := resourceAttrInit(resourceId, csdKubernetesNodePoolBasicMap)
...
func TestAccApsaraStackCSKubernetesNodePool_PrePaid(t *testing.T) {
	var v *cs.NodePoolDetail

	resourceId := "apsarastack_cs_kubernetes_node_pool.pre_paid_nodepool"
	ra := resourceAttrInit(resourceId, csdKubernetesNodePoolBasicMap)
...
func TestAccApsaraStackCSKubernetesNodePool_Spot(t *testing.T) {
	var v *cs.NodePoolDetail

	resourceId := "apsarastack_cs_kubernetes_node_pool.spot_nodepool"
	ra := resourceAttrInit(resourceId, csdKubernetesNodePoolBasicMap)
