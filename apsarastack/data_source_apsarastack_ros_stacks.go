...
func dataSourceApsaraStackRosStacks() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackRosStacksRead,
...
func dataSourceApsaraStackRosStacksRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_ros_stacks", action, ApsaraStackSdkGoERROR)
		}
