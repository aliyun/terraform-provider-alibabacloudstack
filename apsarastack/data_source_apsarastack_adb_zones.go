...
func dataSourceApsaraStackAdbZones() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackAdbZonesRead,
...
func dataSourceApsaraStackAdbZonesRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_adb_zones", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
