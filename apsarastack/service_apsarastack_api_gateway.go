...
func (s *CloudApiService) DescribeApiGatewayGroup(id string) (*cloudapi.DescribeApiGroupResponse, error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"NotFoundApiGroup"}) {
			return apiGroup, WrapErrorf(err, NotFoundMsg, ApsaraStackSdkGoERROR)
		}
		return apiGroup, WrapErrorf(err, DefaultErrorMsg, id, request.GetActionName(), ApsaraStackSdkGoERROR)
	}
...
func (s *CloudApiService) DescribeApiGatewayApp(id string) (*cloudapi.DescribeAppResponse, error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"NotFoundApp"}) {
			return app, WrapErrorf(err, NotFoundMsg, ApsaraStackSdkGoERROR)
		}
		return app, WrapErrorf(err, DefaultErrorMsg, id, request.GetActionName(), ApsaraStackSdkGoERROR)
	}
	addDebug(request.GetActionName(), raw, request.RpcRequest, request)
...
func (s *CloudApiService) DescribeApiGatewayApi(id string) (*cloudapi.DescribeApiResponse, error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"NotFoundApiGroup", "NotFoundApi"}) {
			return api, WrapErrorf(err, NotFoundMsg, ApsaraStackSdkGoERROR)
		}
		return api, WrapErrorf(err, DefaultErrorMsg, id, request.GetActionName(), ApsaraStackSdkGoERROR)
	}
	addDebug(request.GetActionName(), raw, request.RpcRequest, request)
...
func (s *CloudApiService) DescribeApiGatewayVpcAccess(id string) (*cloudapi.VpcAccessAttribute, error) {
	...
	for {
		...
		if err != nil {
			return vpc, WrapErrorf(err, DefaultErrorMsg, id, request.GetActionName(), ApsaraStackSdkGoERROR)
		}
		addDebug(request.GetActionName(), raw, request.RpcRequest, request)
