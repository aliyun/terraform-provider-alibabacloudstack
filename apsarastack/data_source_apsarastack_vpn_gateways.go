...
func dataSourceApsaraStackVpnGateways() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackVpnsRead,
...
func dataSourceApsaraStackVpnsRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_vpn_gateways", request.GetActionName(), ApsaraStackSdkGoERROR)
		}
