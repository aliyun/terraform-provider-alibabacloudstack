...
func dataSourceApsaraStackDmsEnterpriseUsers() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackDmsEnterpriseUsersRead,
...
func dataSourceApsaraStackDmsEnterpriseUsersRead(d *schema.ResourceData, meta interface{}) error {
