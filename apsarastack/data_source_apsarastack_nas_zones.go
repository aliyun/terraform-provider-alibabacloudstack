...
func dataSourceApsaraStackNasZones() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackNasZonesRead,
...
func dataSourceApsaraStackNasZonesRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_nas_zones", action, ApsaraStackSdkGoERROR)
	}
