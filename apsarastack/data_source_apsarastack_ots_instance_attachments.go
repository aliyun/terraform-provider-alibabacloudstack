...
func dataSourceApsaraStackOtsInstanceAttachments() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackOtsInstanceAttachmentsRead,
...
func dataSourceApsaraStackOtsInstanceAttachmentsRead(d *schema.ResourceData, meta interface{}) error {
