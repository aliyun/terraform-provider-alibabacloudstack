...
func resourceApsaraStackEcsDedicatedHost() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackEcsDedicatedHostCreate,
		Read:   resourceApsaraStackEcsDedicatedHostRead,
		Update: resourceApsaraStackEcsDedicatedHostUpdate,
		Delete: resourceApsaraStackEcsDedicatedHostDelete,
...
func resourceApsaraStackEcsDedicatedHostCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_ecs_dedicated_host", action, ApsaraStackSdkGoERROR)
	}
	...
	return resourceApsaraStackEcsDedicatedHostRead(d, meta)
}
func resourceApsaraStackEcsDedicatedHostRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	ecsService := EcsService{client}
	object, err := ecsService.DescribeEcsDedicatedHost(d.Id())
	if err != nil {
		if NotFoundError(err) {
			log.Printf("[DEBUG] Resource apsarastack_ecs_dedicated_host ecsService.DescribeEcsDedicatedHost Failed!!! %s", err)
			d.SetId("")
			return nil
		}
		return WrapError(err)
...
func resourceApsaraStackEcsDedicatedHostUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	ecsService := EcsService{client}
	var response map[string]interface{}
	d.Partial(true)
	...
	if update {
		...
		modifyDedicatedHostsChargeTypeReq["product"] = "Ecs"
		modifyDedicatedHostsChargeTypeReq["organizationId"] = client.Department
		conn, err := client.NewEcsClient()
		if err != nil {
			return WrapError(err)
		}
	...
	if update {
		...
		modifyDedicatedHostAttributeReq["product"] = "Ecs"
		modifyDedicatedHostAttributeReq["organizationId"] = client.Department
		conn, err := client.NewEcsClient()
		if err != nil {
			return WrapError(err)
		}
...
func resourceApsaraStackEcsDedicatedHostDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
