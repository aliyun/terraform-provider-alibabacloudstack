...
func init() {
	resource.AddTestSweepers("apsarastack_alikafka_sasl_user", &resource.Sweeper{
		Name: "apsarastack_alikafka_sasl_user",
...
func TestAccApsaraStackAlikafkaSaslUser_basic(t *testing.T) {

	//var v *alikafka.SaslUserVO
	var v *alikafka.SaslUserList
	resourceId := "apsarastack_alikafka_sasl_user.default"
...
/*
func TestAccApsaraStackAlikafkaSaslUser_multi(t *testing.T) {

	var v *alikafka.SaslUserVO
	resourceId := "apsarastack_alikafka_sasl_user.default.1"
	ra := resourceAttrInit(resourceId, alikafkaSaslUserBasicMap)
	serviceFunc := func() interface{} {
		return &AlikafkaService{testAccProvider.Meta().(*connectivity.ApsaraStackClient)}
	}
