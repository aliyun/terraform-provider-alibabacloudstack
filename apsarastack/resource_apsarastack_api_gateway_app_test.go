...
func init() {
	resource.AddTestSweepers("apsarastack_api_gateway_app", &resource.Sweeper{
		Name: "apsarastack_api_gateway_app",
...
func SkipTestAccApsaraStackApigatewayApp_basic(t *testing.T) {
	var v *cloudapi.DescribeAppResponse

	resourceId := "apsarastack_api_gateway_app.default"
...
func SkipTestAccApsaraStackApigatewayApp_multi(t *testing.T) {
	var v *cloudapi.DescribeAppResponse
	resourceId := "apsarastack_api_gateway_app.default.9"
	ra := resourceAttrInit(resourceId, apigatewayAppBasicMap)
	serviceFunc := func() interface{} {
		return &CloudApiService{testAccProvider.Meta().(*connectivity.ApsaraStackClient)}
	}
