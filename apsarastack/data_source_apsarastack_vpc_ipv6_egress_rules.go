...
func dataSourceApsaraStackVpcIpv6EgressRules() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackVpcIpv6EgressRulesRead,
...
func dataSourceApsaraStackVpcIpv6EgressRulesRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_vpc_ipv6_egress_rules", action, ApsaraStackSdkGoERROR)
		}
