...
func dataSourceApsaraStackDmsEnterpriseInstances() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackDmsEnterpriseInstancesRead,
...
func dataSourceApsaraStackDmsEnterpriseInstancesRead(d *schema.ResourceData, meta interface{}) error {
