...
func dataSourceApsaraStackAccessRules() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackAccessRulesRead,
...
func dataSourceApsaraStackAccessRulesRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_nas_access_rules", action, ApsaraStackSdkGoERROR)
		}
