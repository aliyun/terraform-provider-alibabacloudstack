...
func dataSourceApsaraStackTsdbZones() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackTsdbZonesRead,
...
func dataSourceApsaraStackTsdbZonesRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_tsdb_zones", action, ApsaraStackSdkGoERROR)
	}
