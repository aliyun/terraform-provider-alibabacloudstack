...
func resourceApsaraStackOtsInstanceAttachment() *schema.Resource {
...
func resourceAliyunOtsInstanceAttachmentCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_ots_instance_attachment", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
