...
func resourceApsaraStackHBaseInstance() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackHBaseInstanceCreate,
		Read:   resourceApsaraStackHBaseInstanceRead,
		Update: resourceApsaraStackHBaseInstanceUpdate,
		Delete: resourceApsaraStackHBaseInstanceDelete,
...
func resourceApsaraStackHBaseInstanceCreate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_hbase_instance", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
	...
	return resourceApsaraStackHBaseInstanceUpdate(d, meta)
}

func resourceApsaraStackHBaseInstanceRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	hbaseService := HBaseService{client}
...
func resourceApsaraStackHBaseInstanceUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	hBaseService := HBaseService{client}
	d.Partial(true)
	...
	if d.IsNewResource() {
		d.Partial(false)
		return resourceApsaraStackHBaseInstanceRead(d, meta)
	}
...
func resourceApsaraStackHBaseInstanceDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	hbaseService := HBaseService{client}
