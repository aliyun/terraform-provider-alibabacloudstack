...
func dataSourceApsaraStackEcsCommands() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackEcsCommandsRead,
...
func dataSourceApsaraStackEcsCommandsRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_ecs_commands", action, ApsaraStackSdkGoERROR)
		}
