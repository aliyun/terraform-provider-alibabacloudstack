...
func dataSourceApsaraStackGpdbAccounts() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackGpdbAccountsRead,
...
func dataSourceApsaraStackGpdbAccountsRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_gpdb_accounts", action, ApsaraStackSdkGoERROR)
	}
