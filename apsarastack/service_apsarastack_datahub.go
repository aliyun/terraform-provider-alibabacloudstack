...
func (s *DatahubService) DescribeDatahubProject(id string) (*datahub.GetProjectResult, error) {
	...
	if err != nil {
		if isDatahubNotExistError(err) {
			return resp, WrapErrorf(err, NotFoundMsg, ApsaraStackDatahubSdkGo)
		}
		return resp, WrapErrorf(err, DefaultErrorMsg, id, "GetProject", ApsaraStackDatahubSdkGo)
	}
...
func (s *DatahubService) DescribeDatahubSubscription(id string) (*datahub.GetSubscriptionResult, error) {
	...
	if err != nil {
		if isDatahubNotExistError(err) {
			return subscription, WrapErrorf(err, NotFoundMsg, ApsaraStackDatahubSdkGo)
		}
		return subscription, WrapErrorf(err, DefaultErrorMsg, id, "GetSubscription", ApsaraStackDatahubSdkGo)
	}
	if debugOn() {
...
func (s *DatahubService) DescribeDatahubTopic(id string) (*GetTopicResult, error) {
	...
	if err != nil {
		if isDatahubNotExistError(err) {
			return topic, WrapErrorf(err, NotFoundMsg, ApsaraStackDatahubSdkGo)
		}
		return topic, WrapErrorf(err, DefaultErrorMsg, id, "GetTopic", ApsaraStackDatahubSdkGo)
	}
	if debugOn() {
		requestMap := make(map[string]string)
		requestMap["ProjectName"] = projectName
