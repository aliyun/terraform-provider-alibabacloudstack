...
func init() {
	resource.AddTestSweepers("apsarastack_ots_instance", &resource.Sweeper{
		Name: "apsarastack_ots_instance",
...
func TestAccApsaraStackOtsInstance_basic(t *testing.T) {
	var v ots.InstanceInfo

	resourceId := "apsarastack_ots_instance.default"
...
/*
func TestAccApsaraStackOtsInstanceHighPerformance(t *testing.T) {
	var v ots.InstanceInfo
...
func TestAccApsaraStackOtsInstance_multi(t *testing.T) {
	var v ots.InstanceInfo

	resourceId := "apsarastack_ots_instance.default.4"
	ra := resourceAttrInit(resourceId, otsInstanceBasicMap)
