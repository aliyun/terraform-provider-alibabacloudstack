...
func TestAccApsaraStackVpcIpv6InternetBandwidthsDataSource(t *testing.T) {
	resourceId := "data.apsarastack_vpc_ipv6_internet_bandwidths.default"
	...
	idsConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"ids": []string{"${apsarastack_vpc_ipv6_internet_bandwidth.default.id}"},
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"ids": []string{"${apsarastack_vpc_ipv6_internet_bandwidth.default.id}-fake"},
		}),
	}
	ipv6InternetBandwidthIdConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"ipv6_internet_bandwidth_id": "${apsarastack_vpc_ipv6_internet_bandwidth.default.id}",
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"ipv6_internet_bandwidth_id": "${apsarastack_vpc_ipv6_internet_bandwidth.default.id}_fake",
		}),
	}
	ipv6AddressIdConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"ids":             []string{"${apsarastack_vpc_ipv6_internet_bandwidth.default.id}"},
			"ipv6_address_id": "${apsarastack_vpc_ipv6_internet_bandwidth.default.ipv6_address_id}",
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"ids":             []string{"${apsarastack_vpc_ipv6_internet_bandwidth.default.id}"},
			"ipv6_address_id": "${apsarastack_vpc_ipv6_internet_bandwidth.default.ipv6_address_id}_fake",
		}),
	}
...
resource "apsarastack_vpc_ipv6_internet_bandwidth" "default" {
