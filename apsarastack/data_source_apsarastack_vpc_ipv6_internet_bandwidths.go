...
func dataSourceApsaraStackVpcIpv6InternetBandwidths() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackVpcIpv6InternetBandwidthsRead,
...
func dataSourceApsaraStackVpcIpv6InternetBandwidthsRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_vpc_ipv6_internet_bandwidths", action, ApsaraStackSdkGoERROR)
		}
