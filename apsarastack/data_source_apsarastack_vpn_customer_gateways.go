...
func dataSourceApsaraStackVpnCustomerGateways() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackVpnCgwsRead,
...
func dataSourceApsaraStackVpnCgwsRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_vpn_customer_gateways", request.GetActionName(), ApsaraStackSdkGoERROR)
		}
