...
func resourceApsaraStackDtsSynchronizationJob() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackDtsSynchronizationJobCreate,
		Read:   resourceApsaraStackDtsSynchronizationJobRead,
		Update: resourceApsaraStackDtsSynchronizationJobUpdate,
		Delete: resourceApsaraStackDtsSynchronizationJobDelete,
...
func resourceApsaraStackDtsSynchronizationJobCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_dts_synchronization_job", action, ApsaraStackSdkGoERROR)
	}
	...
	return resourceApsaraStackDtsSynchronizationJobUpdate(d, meta)
}
func resourceApsaraStackDtsSynchronizationJobRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	dtsService := DtsService{client}
	object, err := dtsService.DescribeDtsSynchronizationJob(d.Id())
	if err != nil {
		if NotFoundError(err) {
			log.Printf("[DEBUG] Resource apsarastack_dts_synchronization_job dtsService.DescribeDtsSynchronizationJob Failed!!! %s", err)
			d.SetId("")
			return nil
		}
		return WrapError(err)
...
func resourceApsaraStackDtsSynchronizationJobUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	var response map[string]interface{}
	d.Partial(true)
	...
	if !d.IsNewResource() && d.HasChange("source_endpoint_password") {
		...
		err = resourceApsaraStackDtsSynchronizationJobStatusFlow(d, meta, target)
		if err != nil {
	...
	d.Partial(false)
	return resourceApsaraStackDtsSynchronizationJobRead(d, meta)
}
func resourceApsaraStackDtsSynchronizationJobDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	action := "ResetDtsJob"
	var response map[string]interface{}
	conn, err := client.NewDtsClient()
...
func resourceApsaraStackDtsSynchronizationJobStatusFlow(d *schema.ResourceData, meta interface{}, target string) error {
