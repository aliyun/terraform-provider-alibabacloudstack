...
func resourceApsaraStackDatahubProject() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackDatahubProjectCreate,
		Read:   resourceApsaraStackDatahubProjectRead,
		Update: resourceApsaraStackDatahubProjectUpdate,
		Delete: resourceApsaraStackDatahubProjectDelete,
...
func resourceApsaraStackDatahubProjectCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_datahub_project", request.GetActionName(), ApsaraStackDatahubSdkGo)
	}
	if debugOn() {
...
func resourceApsaraStackDatahubProjectRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
...
func resourceApsaraStackDatahubProjectDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	datahubService := DatahubService{client}
	projectName := d.Id()
	request := requests.NewCommonRequest()
	...
	if err != nil {
		...
		return WrapErrorf(err, DefaultErrorMsg, d.Id(), "DeleteProject", ApsaraStackDatahubSdkGo)
	}
