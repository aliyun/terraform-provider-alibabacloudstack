...
func init() {
	resource.AddTestSweepers("apsarastack_datahub_project", &resource.Sweeper{
		Name: "apsarastack_datahub_project",
...
func TestAccApsaraStackDatahubProject_basic(t *testing.T) {
	var v *datahub.GetProjectResult
	resourceId := "apsarastack_datahub_project.default"
...
func TestAccApsaraStackDatahubProject_multi(t *testing.T) {
	var v *datahub.GetProjectResult

	resourceId := "apsarastack_datahub_project.default.4"
	ra := resourceAttrInit(resourceId, datahubProjectBasicMap)
