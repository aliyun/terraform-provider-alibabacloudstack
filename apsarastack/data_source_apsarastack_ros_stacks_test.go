...
func TestAccApsaraStackRosStacksDataSource(t *testing.T) {
	resourceId := "data.apsarastack_ros_stacks.default"
	...
	nameRegexConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"name_regex":     "${apsarastack_ros_stack.default.stack_name}",
			"enable_details": "true",
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"name_regex":     "${apsarastack_ros_stack.default.stack_name}-fake",
			"enable_details": "true",
		}),
	}
	tagsConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"ids":            []string{"${apsarastack_ros_stack.default.id}"},
			"enable_details": "true",
	...
	idsConf := dataSourceTestAccConfig{
		...
		fakeConfig: testAccConfig(map[string]interface{}{
			"ids":            []string{"${apsarastack_ros_stack.default.id}-fake"},
			"enable_details": "true",
		}),
	}
...
func dataSourceRosStacksDependence(name string) string {
	return fmt.Sprintf(`
	resource "apsarastack_ros_stack" "default" {
	  stack_name=   "%s"
