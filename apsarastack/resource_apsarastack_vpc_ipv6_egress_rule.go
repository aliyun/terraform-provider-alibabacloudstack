...
func resourceApsaraStackVpcIpv6EgressRule() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackVpcIpv6EgressRuleCreate,
		Read:   resourceApsaraStackVpcIpv6EgressRuleRead,
		Delete: resourceApsaraStackVpcIpv6EgressRuleDelete,
...
func resourceApsaraStackVpcIpv6EgressRuleCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "alicloud_vpc_ipv6_egress_rule", action, ApsaraStackSdkGoERROR)
	}
	...
	return resourceApsaraStackVpcIpv6EgressRuleRead(d, meta)
}
func resourceApsaraStackVpcIpv6EgressRuleRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	vpcService := VpcService{client}
...
func resourceApsaraStackVpcIpv6EgressRuleDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	parts, err := ParseResourceId(d.Id(), 2)
	if err != nil {
		return WrapError(err)
