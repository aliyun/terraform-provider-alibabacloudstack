...
func init() {
	resource.AddTestSweepers("apsarastack_vpn_gateway", &resource.Sweeper{
		Name: "apsarastack_vpn_gateway",
		F:    testSweepVPNGateways,
		Dependencies: []string{
			"apsarastack_ssl_vpn_server",
			"apsarastack_ssl_vpn_client_cert",
		},
	})
}
...
func TestAccApsaraStackVpnGatewayBasic(t *testing.T) {
	var v vpc.DescribeVpnGatewayResponse

	resourceId := "apsarastack_vpn_gateway.default"
...
func TestAccApsaraStackVpnGatewayMulti(t *testing.T) {
	var v vpc.DescribeVpnGatewayResponse

	resourceId := "apsarastack_vpn_gateway.default.4"
