...
func dataSourceApsaraStackVpcIpv6Addresses() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackVpcIpv6AddressesRead,
...
func dataSourceApsaraStackVpcIpv6AddressesRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_vpc_ipv6_addresses", action, ApsaraStackSdkGoERROR)
		}
