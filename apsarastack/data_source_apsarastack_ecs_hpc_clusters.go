...
func dataSourceApsaraStackEcsHpcClusters() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackEcsHpcClustersRead,
...
func dataSourceApsaraStackEcsHpcClustersRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_ecs_hpc_clusters", action, ApsaraStackSdkGoERROR)
		}
