...
func TestAccApsarastackVpnConnectionBasic(t *testing.T) {
	var v vpc.DescribeVpnConnectionResponse

	resourceId := "apsarastack_vpn_connection.default"
...
func TestAccApsarastackVpnConnectionMulti(t *testing.T) {
	var v vpc.DescribeVpnConnectionResponse

	resourceId := "apsarastack_vpn_connection.default.1"
	ra := resourceAttrInit(resourceId, testAccVpnConnectionCheckMap)
