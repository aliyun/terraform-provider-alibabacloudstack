...
func dataSourceApsaraStackEhpcJobTemplates() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackEhpcJobTemplatesRead,
...
func dataSourceApsaraStackEhpcJobTemplatesRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_ehpc_job_templates", action, ApsaraStackSdkGoERROR)
		}
