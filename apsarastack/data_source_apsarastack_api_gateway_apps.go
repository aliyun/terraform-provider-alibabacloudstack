...
func dataSourceApsaraStackApiGatewayApps() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackApigatewayAppsRead,
...
func dataSourceApsaraStackApigatewayAppsRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_api_gateway_apps", request.GetActionName(), ApsaraStackSdkGoERROR)
		}
