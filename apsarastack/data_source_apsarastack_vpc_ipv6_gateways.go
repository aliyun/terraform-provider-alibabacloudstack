...
func dataSourceApsaraStackVpcIpv6Gateways() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackVpcIpv6GatewaysRead,
...
func dataSourceApsaraStackVpcIpv6GatewaysRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "alicloud_vpc_ipv6_gateways", action, ApsaraStackSdkGoERROR)
		}
