...
func resourceApsaraStackDatahubTopic() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackDatahubTopicCreate,
		Read:   resourceApsaraStackDatahubTopicRead,
		Update: resourceApsaraStackDatahubTopicUpdate,
		Delete: resourceApsaraStackDatahubTopicDelete,
...
func resourceApsaraStackDatahubTopicCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_datahub_topic", "CreateTopic", ApsaraStackDatahubSdkGo)
	}
	...
	return resourceApsaraStackDatahubTopicRead(d, meta)
}

func resourceApsaraStackDatahubTopicRead(d *schema.ResourceData, meta interface{}) error {
...
func resourceApsaraStackDatahubTopicUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	//	})
	//	if err != nil {
	//		return WrapErrorf(err, DefaultErrorMsg, d.Id(), "UpdateTopic", ApsaraStackDatahubSdkGo)
	//	}
	//	if debugOn() {
...
func resourceApsaraStackDatahubTopicDelete(d *schema.ResourceData, meta interface{}) error {
	parts, err := ParseResourceId(d.Id(), 2)
	if err != nil {
		return WrapError(err)
	}
	...
	if err != nil {
		...
		return WrapErrorf(err, DefaultErrorMsg, d.Id(), "DeleteTopic", ApsaraStackDatahubSdkGo)
	}
