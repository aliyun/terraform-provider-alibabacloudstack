...
func resourceApsaraStackElasticsearch() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackElasticsearchCreate,
		Read:   resourceApsaraStackElasticsearchRead,
		Update: resourceApsaraStackElasticsearchUpdate,
		Delete: resourceApsaraStackElasticsearchDelete,
...
func resourceApsaraStackElasticsearchCreate(d *schema.ResourceData, meta interface{}) error {
	...
	addDebug(action, response, nil)
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_elasticsearch_instance", action, ApsaraStackSdkGoERROR)
	}
	...
	return resourceApsaraStackElasticsearchUpdate(d, meta)
}

func resourceApsaraStackElasticsearchRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	elasticsearchService := ElasticsearchService{client}
...
func resourceApsaraStackElasticsearchUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	elasticsearchService := ElasticsearchService{client}
	d.Partial(true)
	...
	if d.IsNewResource() {
		d.Partial(false)
		return resourceApsaraStackElasticsearchRead(d, meta)
	}
...
func resourceApsaraStackElasticsearchDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	elasticsearchService := ElasticsearchService{client}
