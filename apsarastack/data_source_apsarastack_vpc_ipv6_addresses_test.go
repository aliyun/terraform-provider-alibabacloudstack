...
func TestAccApsaraStackVpcIpv6AddressesDataSource(t *testing.T) {
	resourceId := "data.apsarastack_vpc_ipv6_addresses.default"
	...
	associatedInstanceIdConf := dataSourceTestAccConfig{
		...
		fakeConfig: testAccConfig(map[string]interface{}{
			"associated_instance_id": "${data.apsarastack_instances.default.instances.0.id}_fake",
		}),
	}
	vswitchIdConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"vswitch_id": "${data.apsarastack_vpcs.default.vpcs.0.vswitch_ids.0}",
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"vswitch_id": "${data.apsarastack_vpcs.default.vpcs.0.vswitch_ids.0}_fake",
		}),
	}
	vpcIdConf := dataSourceTestAccConfig{
		...
		fakeConfig: testAccConfig(map[string]interface{}{
			"vpc_id": "${data.apsarastack_vpcs.default.ids.0}_fake",
		}),
	}
