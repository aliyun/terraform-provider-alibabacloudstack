...
func resourceApsaraStackApigatewayApi() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackApigatewayApiCreate,
		Read:   resourceApsaraStackApigatewayApiRead,
		Update: resourceApsaraStackApigatewayApiUpdate,
		Delete: resourceApsaraStackApigatewayApiDelete,
...
func resourceApsaraStackApigatewayApiCreate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	request, err := buildApsaraStackApiArgs(d, meta)
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_api-gateway_api", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
	...
	return resourceApsaraStackApigatewayApiRead(d, meta)
}

func resourceApsaraStackApigatewayApiRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
...
func resourceApsaraStackApigatewayApiUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
...
func resourceApsaraStackApigatewayApiDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	cloudApiService := CloudApiService{client}
...
func buildApsaraStackApiArgs(d *schema.ResourceData, meta interface{}) (*cloudapi.CreateApiRequest, error) {
